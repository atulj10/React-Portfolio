...
const Logo = () => {
    ...
    useEffect(() => {
        ...
        /*draw svgplugin effect isn't working*/
    ...
    {/**The above useRef is for storing the refernce of the logo its outline and solid logo seperalty */ }

    return <div className='logo-container' ref={bgRef}>
        {/* <img className='solid-logo' ref={solidLogoRef} src={LogoS} alt='Logo-img' /> */}
